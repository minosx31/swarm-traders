...
| `VITE_EVENT_DELAY_MS` | Static-mode replay base beat (ms); scales the whole timeline — beats are sized per event (text length, tool runtime) for a live feel, keeping a run in ~16-26s | `125` |
